...
<%
	...
	//ServletContext context = getServletContext(); //서블릿 버전
	String sDownloadPath = application.getRealPath(savePath); //JSP 버전


	String sFilePath = sDownloadPath + "/" + fileName;
	byte b[] = new byte[4096];
	FileInputStream in = new FileInputStream(sFilePath);
	String sMimeType = application.getMimeType(sFilePath);
