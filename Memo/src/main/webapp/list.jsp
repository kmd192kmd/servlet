...
<body>
		...
		<div class="item">
			...
			<div>
				<button type="button" class="edit" 
						onclick="location.href='/memo/edit.jsp?seq=<%= rs.getString("seq") %>';">수정하기</button>
				<button type="button" class="del" 
						onclick="location.href='/memo/del.jsp?seq=<%= rs.getString("seq") %>';">삭제하기</button>
			</div>
		</div>
		<% 
			}
	...
	<div>
		<button type="button" class="add"
			onclick="location.href='/memo/add.jsp';">쓰기</button>
	</div>
